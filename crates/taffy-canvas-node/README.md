...
- the same XML renderer surface as Rust, including inline text spans, inline images, richer text styling, and grid layouts with repeat/minmax/fit-content tracks
