...
const linkArgs = [
  ...
  '-sEXPORTED_FUNCTIONS=["_last_error_len","_last_error_message","_last_error_ptr","_last_output_base64","_last_output_len","_last_output_ptr","_render_png","_version_len","_version_ptr"]',
